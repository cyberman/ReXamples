 ...
 *
 *  Purpose:
 *      Application state for the layout lesson.
 *
 *****************************************************************************/
 ...
 *
 *  Purpose:
 *      Create a window that visibly demonstrates vertical and horizontal layout
 *      grouping without adding interaction yet.
 *
 *****************************************************************************/
