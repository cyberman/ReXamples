 ...
 *
 *  Purpose:
 *      Create a lesson window that demonstrates static structured text inside
 *      a normal native layout.
 *
 *  Notes:
 *      This lesson intentionally keeps text display simple. It teaches
 *      presentation, not text editing or document systems.
 *
 *****************************************************************************/
...
static int UI_Create(struct App *app)
{
    ...
    app->win_obj =
        WindowObject,
            WA_Title,       (ULONG)"ReXamples - 17_TextDisplay",
            WA_Activate,    TRUE,
            WA_DepthGadget, TRUE,
            WA_DragBar,     TRUE,
            WA_CloseGadget, TRUE,
            ...
            WINDOW_Layout,
                VLayoutObject,
                    ...
                    StartMember,
                        ButtonObject,
                            GA_ReadOnly, TRUE,
                            GA_Text, (ULONG)"Static text can support structure.",
                        End,
                    EndMember,
                    ...
                    StartMember,
                        ButtonObject,
                            GA_ReadOnly, TRUE,
                            GA_Text, (ULONG)"This lesson teaches presentation,",
                        End,
                    EndMember,
